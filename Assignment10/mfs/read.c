...
int fs_readwrite(void)
{
  ...
  if(immediate == 1) {
    if(rw_flag == READING) {
      printf("Minix3 [210010020_210010006]: Reading from Immediate File.\n");
      ...
      printf("Minix3 [210010020_210010006]: File Contents of Immediate File:\n");
      for(i = 0; i < f_size; ++i) {
        printf("%c", buffer[i]);
      }
      printf("Minix3 [210010020_210010006]: EOF - Immediate File\n");
      ...
      printf("Minix3 [210010020_210010006]: Writing to Immediate File.\n");
      vir_bytes zone;
